...
Команда разработки:
- :white_check_mark: [Сергей Емельянов (в роли Python-разработчика Тимлид - разработчик 1)](https://github.com/emelyanov-sergey)
- :white_check_mark: [Никита Зайцев (в роли Python-разработчика - разработчик 2)](https://github.com/h0te1)
- :white_check_mark: [Артем Лашин (в роли Python-разработчика - разработчик 3)](https://github.com/sntchweb)
